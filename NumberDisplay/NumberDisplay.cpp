...
NumberDisplay::NumberDisplay(int8_t cs, int8_t dc, int8_t rst) :
  Adafruit_ST77xx(240, 280, cs, dc, rst) {}

NumberDisplay::NumberDisplay(int8_t cs, int8_t dc, int8_t mosi, int8_t sclk, int8_t rst) :
  Adafruit_ST77xx(240, 280, cs, dc, mosi, sclk,rst) {}

NumberDisplay::NumberDisplay(SPIClass *spiClass, int8_t cs, int8_t dc, int8_t rst) :
